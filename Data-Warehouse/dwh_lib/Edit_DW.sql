...
CREATE TABLE [dbo].[Trinh_do] (
	...
	CONSTRAINT [PK_Trinh_do] PRIMARY KEY CLUSTERED ([ID]),
);
------N Bảng [Khoa_hoc] ------
CREATE TABLE [dbo].[Khoa_hoc] (
    ...
    CONSTRAINT [UQ_Ten_khoa_hoc] UNIQUE ([Ten_khoa_hoc])
);
...
CREATE TABLE [dbo].[Lop] (
	...
	CONSTRAINT [UQ_Ten_lop] UNIQUE ([Ten_lop])
);
...
CREATE TABLE [dbo].[Ban_doc] (
	...
	CONSTRAINT [FK_Ban_doc_Dan_toc] FOREIGN KEY ([Dan_toc_ID]) REFERENCES [dbo].[Dan_toc]([ID]),
	CONSTRAINT [FK_Ban_doc_Trinh_do] FOREIGN KEY ([Trinh_do_ID]) REFERENCES [dbo].[Trinh_do]([ID]),
	CONSTRAINT [FK_Ban_doc_Khoa_hoc] FOREIGN KEY ([Khoa_hoc]) REFERENCES [dbo].[Khoa_hoc]([Ten_khoa_hoc]),
	CONSTRAINT [FK_Ban_doc_Lop] FOREIGN KEY ([Lop]) REFERENCES [dbo].[Lop]([Ten_lop])
);
...
CREATE TABLE [dbo].[Ma_xep_gia] (
	...
	CONSTRAINT [FK_Ma_xep_gia_Tai_lieu] FOREIGN KEY ([Tai_lieu_ID]) REFERENCES [dbo].[Tai_lieu]([Tai_lieu_ID]),
	CONSTRAINT [FK_Ma_xep_gia_Thu_vien] FOREIGN KEY ([Ten_thu_vien_ID]) REFERENCES [dbo].[Thu_vien]([Thu_vien_ID]),
	CONSTRAINT [FK_Ma_xep_gia_Kho] FOREIGN KEY ([Kho_ID]) REFERENCES [dbo].[Kho]([Kho_ID]),
	CONSTRAINT [FK_Ma_xep_gia_LoanType] FOREIGN KEY ([LoanTypeID]) REFERENCES [dbo].[LoanType]([LoanTypeID])
);
...
CREATE TABLE [dbo].[An_pham_cho_muon] (
    ...
    [LoanType] SMALLINT NOT NULL CONSTRAINT [DF_An_pham_cho_muon_LoanType] DEFAULT (1),
	...
	--CONSTRAINT [FK_An_pham_cho_muon_Ma_xep_gia] FOREIGN KEY ([Ma_xep_gia]) REFERENCES [dbo].[Ma_xep_gia]([ID]),
	CONSTRAINT [FK_An_pham_cho_muon_LoanType] FOREIGN KEY ([LoanType]) REFERENCES [dbo].[LoanType]([LoanTypeID])
);
...
CREATE TABLE [dbo].[Lich_su_muon_sach] (
	[ID] INT IDENTITY(1,1) NOT NULL,
    [Tai_lieu_ID] INT NOT NULL,
    [Ma_xep_gia] NVARCHAR(32) NOT NULL,
    [So_the_ID] INT NULL,
	...
	--CONSTRAINT [FK_Lich_su_muon_sach_Ma_xep_gia] FOREIGN KEY ([Ma_xep_gia]) REFERENCES [dbo].[Ma_xep_gia]([Ma_xep_gia])
);
